/*!
 * @prisjakt/react-meta-tags - 1.0.0
	...
	var MetaTags = function (_Component) {
	  ...
	  _createClass(MetaTags, [{
	    ...
	    value: function handleChildrens() {
	      var overwrite = this.props.overwrite;
	      ...
	      if (overwrite) {
	        var nodes = Array.prototype.slice.call(head.querySelectorAll('[data-source=react-meta-tags]'));
